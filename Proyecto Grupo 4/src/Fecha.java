...
public class Fecha {
	...
	public Fecha(Integer dia, Integer mes, Integer anyo) {
		...
		while (!comprobante) {
			...
			this.mes = mes;
			this.anio = anyo;
			comprobante = esCorrecta(dia, mes, anyo);
			if (!comprobante) {
	...
	/**
	 * @return boolean bisiesto pero sin fecha, con un n�mero para el a�o
	 */
	...
	/**
	 * @return Integer diasMes con un n�mero para mes y a�o
	 */
	...
	/**
	 * @return Integer dias desde 1-1-1583 V1
	 */
	...
	/**
	 * @return Integer diferencia entre las fechas. Si la fecha del par�mentro
	 *         es menor que la de invocaci�n, el resultado ser� negativo si es
	 *         mayor que la fecha con la que se invoca, ser� positivo.
	 */
	...
	/**
	 * @return Fecha suma d�as a una fecha. El n�mero debe ser > que cero
	 */
