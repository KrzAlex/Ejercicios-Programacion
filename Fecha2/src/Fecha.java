...
public class Fecha {
	 ...
	 * @param anyo
	 */
	private Fecha(Integer dia, Integer mes, Integer anyo) {
			this.dia = dia;
			this.mes = mes;
			this.anio = anyo;		
	...
	public static Fecha getInstance(Integer dia, Integer mes, Integer anyo){
		Fecha fecha=null;
	 ...
	 */
	private static Boolean esCorrecta(Integer dia, Integer mes, Integer anyo) {
	...
	private static Boolean esBisiesto(Integer anyo) {
	 ...
	 */
	private static Integer diasMes(Integer mes, Integer anyo) {
		Integer diasMes;
