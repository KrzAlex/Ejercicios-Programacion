...
public class Ejercicio41 {
	...
	/**
	 * @param args
	 * Se dispone de una tabla de 5 páginas, 10 filas y 20 columnas, que se refieren al centro, 
	 * al curso y al número de alumnos de un colegio respectivamente. 
	 * Imprimir la nota media por curso y la nota media máxima y su centro de pertenencia.
	 */
